...
from apps.marketdata.providers.Crypto.dto.responses.simple_price import parse_simple_price
...
class CoinGeckoProvider(Provider):
    ...
    async def ping(self) -> Dict[str, Any]:
        ...
        await self.cache.set(self.k_ping(), data, ttl=self.TTL_PING)
        return data
    ...
    async def simple_supported_vs_currencies(self) -> List[str]:
        ...
        await self.cache.set(self.k_supported_vs(), data, ttl=self.TTL_SUPPORTED_VS_CURRENCIES)
        return data

    # Coins
    async def coins_list(self, include_platform: bool = False) -> List[Dict[str, Any]]:
    ...
    async def coin_tickers(self, coin_id: str, *, page: int = 1, exchange_ids: Optional[str] = None, include_exchange_logo: bool = True, order: str = "trust_score_desc", depth: bool = False) -> Dict[str, Any]:
    ...
    async def exchange_tickers(self, ex_id: str, *, page: int = 1, coin_ids: Optional[str] = None, depth: bool = False, order: str = "trust_score_desc") -> Dict[str, Any]:
