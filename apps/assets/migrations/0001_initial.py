    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('trading_currency', models.ForeignKey(blank=True, db_column='trading_currency_id', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assets', to='assets.currency')),
                ('exchange', models.ForeignKey(blank=True, db_column='exchange_id', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assets', to='assets.exchange')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_currency', models.ForeignKey(db_column='base_currency_id', on_delete=django.db.models.deletion.PROTECT, related_name='fx_base', to='assets.currency')),
                ('quote_currency', models.ForeignKey(db_column='quote_currency_id', on_delete=django.db.models.deletion.PROTECT, related_name='fx_quote', to='assets.currency')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(default=dict)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('asset', models.ForeignKey(db_column='asset_id', on_delete=django.db.models.deletion.CASCADE, related_name='prices', to='assets.asset')),
                ('currency', models.ForeignKey(db_column='currency_id', on_delete=django.db.models.deletion.PROTECT, related_name='prices', to='assets.currency')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(db_column='asset_id', on_delete=django.db.models.deletion.CASCADE, related_name='identifiers', to='assets.asset')),
            ],
            options={
