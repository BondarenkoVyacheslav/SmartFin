...
class PortfolioMutations:
    ...
    @strawberry.mutation
    def add_asset_to_portfolio(self, portfolio_id: int, asset_id: int, quantity: float) -> PortfolioAssetType:
        portfolio = Portfolio.objects.get(id=portfolio_id)
        asset = Asset.objects.get(id=asset_id)
        return PortfolioAsset.objects.create(portfolio=portfolio, asset=asset, quantity=quantity)
