...
SECRET_KEY = 'django-insecure-h-*oi9!v9v6+ftu-)9_h%1n7g&2^d7gfgr*rjh5br*nb1-p-84'
...
DATABASES = {
    "default": {
        ...
        "NAME": "smartfin",  # имя БД в Postgres
        "USER": "smartfin",  # пользователь БД
        "PASSWORD": "secret",  # пароль
        "HOST": "localhost",  # или сервис в docker: "db"
        "PORT": "5432",
